      ...
      <Row>
          <Col md={3}>
              <div className="card-columns">
                  ...
                  <Card className="info-card mb-3">
                      <Card.Body>
                          <Card.Title className="text-center">Количество уроков</Card.Title>
                          <Card.Text className="value-text">{lessonCount}</Card.Text>
                      </Card.Body>
                  </Card>
                  <Card className="info-card mb-3">
                      <Card.Body>
                          <Card.Title className="text-center">Количество целей</Card.Title>
                              ...
                              <Card.Body>
                                  <Row>
                                      ...
                                      <Col md={5}>
                                          ...
                                          <div className="teacher">{pair.subject.teacher.user.full_name}</div>
                                      </Col>
                                      <Col md={6} className="time-room">
                                          <div>{pairTimes[pair.num_les] || "Время не указано"}</div>
